...
public class Globals {
	...
	public static final String[] fileExtenstions = {"jpg", "xml"};
	...
	public static final String[] HOROLOGYTOPICS = { "A.Lange & Sohne",
			...
			"Peter Speake Marin", "Philippe Dufour", "Piaget",
			"Pinion", "Rado", "Ralph Lauren", "Raymond Weil",
			"Ressence", "Richard Mille", "Roger Dubuis", "Roger W.Smith",
			"Rolex", "Seiko", "Shinola", "Sinn", "Tag Heuer", "TechnoMarine",
			"Thomas Prescher", "Timex", "Tissot", "Tudor", "Ulysse Nardin",
			"Union Glashütte", "Universal Geneve", "Urwerk",
			"Vacheron Constantin", "Victorinox ", "Vulcain", "Xeric",
			"Zeitwinkel", "Zenith (LVMH)" };
